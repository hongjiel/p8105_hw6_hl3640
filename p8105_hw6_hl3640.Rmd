...
For cities whose 95% CI of adjusted odds ratio excludes 1, we have sufficient evidence that the odds of solving homicides among male victims are lower than the odds of solving homicides among female victims. For cities whose 95% CI contains 1, we don't have sufficient evidence that there is a difference between the odds of solving homicides among male victims and the odds of solving homicides among female victims.
...
From the plot, my model seems to have the lowest cross-validated prediction error among the three models, and model B has significantly lower prediction error compared to model A. I will choose my model as the final model in terms of goodness of fit. However, we need to further investigate whether there are any violations of assumptions regarding the residuals vs. fitted values plot.
